...
import nz.com.neps.xero_integration.exception.XeroExceptionHandler;
import nz.com.neps.xero_integration.jaxb.XeroJAXBMarshaller;
...
public class XeroClient {
    ...
    public com.xero.model.BankTransfer getBankTransfer(String id) throws IOException {
    ...
    //CURRENCY
    public List<com.xero.model.Currency> getCurrencies() throws IOException {
    ...
    public List<com.xero.model.Currency> getCurrencies(Date modifiedAfter, String where, String order) throws IOException {
        Map<String, String> params = new HashMap<>();
        addToMapIfNotNull(params, "Where", where);
        addToMapIfNotNull(params, "order", order);
    ...
    public com.xero.model.Currency getCurrency(String id) throws IOException {
